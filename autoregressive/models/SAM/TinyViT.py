...
#     #         x = layer(x) # (N, C, H, W)
#     #     B,_,C=x.size()
#     #     # x = x.view(B, 64, 64, C) # 1024,1024 -> 256,256
#     #     # x = x.view(B, 16, 16, C) # 256,256 -> 16,16
#     #     x = x.view(B, 32, 32, C) # 512,512 -> 32,32
#     #     x=x.permute(0, 3, 1, 2)
#     #     x=self.neck(x)
#     #     return x
...
#         x_mid4 = partial(nn.LayerNorm, eps=1e-6)(160+320+320, elementwise_affine=False)(torch.concat(mid, dim=-1))
#         x_final = partial(nn.LayerNorm, eps=1e-6)(320, elementwise_affine=False)(x)
#         return {
