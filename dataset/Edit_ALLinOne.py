...
class EditALLinOne_Dataset(Dataset):
    def __init__(self,
                 args,
                 dataset_jsonl_path,
                 dataset_dir_path,
        ...
        with open(dataset_jsonl_path, 'r') as f:
            self.dataset_path = [json.loads(line) for line in f]
        self.data_root = dataset_dir_path
    ...
    def __getitem__(self, index):
        ...
        input_img = os.path.join(self.data_root, data['source_image'])
        edited_img = os.path.join(self.data_root, data['target_image'])
        ...
        edited_img = Image.open(edited_img).convert('RGB')
